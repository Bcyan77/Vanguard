...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('parties', '0003_party_activity_alter_party_activity_type'),
    ]
    ...
    operations = [
        ...
        migrations.AlterModelTable(
            name='destinyactivitytype',
            table='parties_destinyactivity',
        ),
        # Step 3: Update existing fields
        migrations.AlterField(
            model_name='party',
            name='activity',
            field=models.ForeignKey(blank=True, help_text='DEPRECATED: Use selected_* fields instead', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='old_parties', to='parties.destinyactivitytype'),
        ),
        migrations.AlterField(
            model_name='party',
            name='activity_type',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['is_active', 'display_order'], name='parties_des_is_acti_829621_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('activity_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='specific_activities', to='parties.destinyactivitytype')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity_mode', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='activities', to='parties.destinyactivitymode')),
                ('specific_activity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='available_modes', to='parties.destinyspecificactivity')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, help_text='Tier 1: Activity Type (Raid, Dungeon, etc.)', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='parties_by_type', to='parties.destinyactivitytype'),
        ),
        migrations.AddField(
            model_name='party',
            name='selected_specific_activity',
            field=models.ForeignKey(blank=True, help_text='Tier 2: Specific Activity (Deep Stone Crypt, etc.)', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='parties', to='parties.destinyspecificactivity'),
        ),
        migrations.AddField(
            model_name='party',
            name='selected_activity_mode',
            field=models.ForeignKey(blank=True, help_text='Tier 3: Difficulty/Mode (Master, Heroic, etc.) - Optional', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='parties_by_mode', to='parties.destinyactivitymode'),
        ),
        # Step 6: Add indexes and constraints
        migrations.AddIndex(
            model_name='destinyspecificactivity',
            index=models.Index(fields=['activity_type', 'is_active'], name='parties_des_activit_142e88_idx'),
        ),
